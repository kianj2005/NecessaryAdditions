package com.therifty.necessaryadditions.client.screen;
...
public class DisplayCaseScreen extends ContainerScreen<DisplayCaseContainer> {
	...
	private static final ResourceLocation DISPLAY_CASE_GUI = new ResourceLocation(NecessaryAdditions.MOD_ID,
